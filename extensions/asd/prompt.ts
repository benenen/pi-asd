  ...
  if (input.agents.length > 0) {
    ...
    sections.push(
      [
        ...
        "  在那之前你可以去干别的、或者回复用户。",
        "- 想主动看一眼状态就调 asd_agents。但它是**看一眼**，不是等：看完就去做",
        "  别的，别拿它当轮询。",
        "- **asd_agents 说的是「它在不在动」，不是「它干成了没有」。** 「安静」只表示",
        "  终端没动静，可能做完了、可能在沉默地想、也可能卡住了。**绝不要因为它看着",
        "  安静就断定失败、然后重发任务** —— 重发只会让它从头再来一遍，或者两份任务",
        "  同时在跑。要判断结果就 asd_peek 看屏幕，那才有真凭据。",
